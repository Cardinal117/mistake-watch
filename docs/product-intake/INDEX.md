...
7. Prepare a research/prototype packet for
   ...
   mutations.
8. Complete refreshed TASK-020 review and production interaction QA for
   [[items/MW-BUG-008-tv-mode-like-control-missing|MW-BUG-008]] and
   [[items/MW-QOL-008-tv-mode-settings-access|MW-QOL-008]] after TASK-022.
   Keep optional TV-mode motion outside this parity bundle.
