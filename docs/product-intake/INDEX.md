...
| [MW-BUG-005](items/MW-BUG-005-cross-device-like-state.md)         | Bug        | P1       | Confirmed          | Recommendations   | Account Like persists but another open client needs refresh | TASK-011           |
...
1. Close TASK-011 persistence proof and resolve
   [[items/MW-BUG-005-cross-device-like-state|MW-BUG-005]].
