...
1. TASK-015A2 owner QA passed. Run TASK-015B as a separately measured
...
2. Reconcile the released TASK-014 guest-footer refinement and completed owner
   QA into the Account Rooms task records before closing
   [[items/MW-FEAT-003-account-rooms-surface|MW-FEAT-003]].
3. Schedule [[items/MW-QOL-008-tv-mode-settings-access|MW-QOL-008]] as a compact
