...
Release: commit/push, server publish and explicitly approved frontend promotion complete.
Live-domain inspection and public health/readiness/protected-route checks pass.
